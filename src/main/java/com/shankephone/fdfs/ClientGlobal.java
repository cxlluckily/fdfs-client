...
import com.shankephone.fdfs.common.*;
...
public class ClientGlobal
{
	...
	public static String g_download_server;
...
*/
	public static void init(String conf_filename) throws FileNotFoundException, IOException, FdfsException
	{
  		...
  		g_download_server = iniReader.getStrValue("download_server");
  		if (g_download_server == null) {
  			g_download_server = "";
  		}
